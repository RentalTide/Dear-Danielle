...
import { featureFlags } from './configFeatureFlags';
...
const defaultConfig = {
  ...
  // Feature flags for Dear Danielle MVP features
  // Modify in configFeatureFlags.js or override via REACT_APP_FF_* env vars
  featureFlags,
